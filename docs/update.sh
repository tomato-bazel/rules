...
PWPY_GEN="$(find "$RUNFILES_DIR" -name playwright_py.md.generated -print -quit)"
PWJS_GEN="$(find "$RUNFILES_DIR" -name playwright_js.md.generated -print -quit)"
...
cp "$PWPY_GEN" "$BUILD_WORKSPACE_DIRECTORY/docs/playwright_py.md"
cp "$PWJS_GEN" "$BUILD_WORKSPACE_DIRECTORY/docs/playwright_js.md"

echo "docs/{defs,extensions,toolchains,playwright_py,playwright_js}.md regenerated."
